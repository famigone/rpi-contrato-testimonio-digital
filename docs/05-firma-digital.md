...
```xml
<TestimonioDigital version="3.0" xmlns="...">
```

como

```xml
<TestimonioDigital version="3.0" Id="_0" xmlns="...">
```
...
## Nota sobre verificación de certificado
...
resuelta antes de la publicación oficial del contrato. El contrato describe
